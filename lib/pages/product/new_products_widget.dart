...
class _NewProductsWidgetState extends State<NewProductsWidget> {
  ...
  Future<void> fetchNewProducts() async {
    try {
      final response = await http.get(Uri.parse("$baseUrl/products/new-product"));
  ...
  Widget build(BuildContext context) {
    int size = _products.length > 5 ? 5 : _products.length;
    return SizedBox(
      height: 365,
      child: ListView(
            ...
            Padding(
              ...
              child: _isLoading
                  ...
                  : GestureDetector(
                      ...
                      child: buildProductContainer(_products[i]),
                    ),
            ),
        ],
      ),
